...
const inputs = {
  ...
  numberInput: document.querySelector("input[id='number']"),
  emailInput: document.querySelector("input[id='email']")
};
...
if (localStorage.length > 0) {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    contacts.insertAdjacentHTML("beforeend", "\n        <li data-root=\"".concat(contact, "\" class=\"contacts-item\">\n                <div class=\"thumb\">\n                    <h3 class=\"name\">").concat(rootMain.nameInput, " ").concat(rootMain.surnameInput, "</h3>\n                    <a class=\"number\" href=\"tel:").concat(rootMain.numberInput, "\">").concat(rootMain.numberInput, "</a>\n                </div>\n                <div class=\"holder\">\n                    <a class=\"email\" href=\"mailto: ").concat(rootMain.emailInput, "\">").concat(rootMain.emailInput, "</a>\n                    <button class=\"close-btn\">X</button>\n                </div>\n            </li>\n            "));
  }
}
form.addEventListener("submit", onFormSubmit);
function onFormSubmit(event) {
  event.preventDefault();
  localStorage.setItem("".concat(nameInput.value, "-").concat(surnameInput.value), JSON.stringify({
...
function onCloseBtnClick(event) {
  ...
  if (deleteBtn.classList.contains("close-btn")) {
    ...
    liItem.remove();
    localStorage.removeItem(liItem.dataset.root);
    if (contacts.children.length === 0) {
      contactsHolder.style.display = 'block';
    }
  }
}
...
//# sourceMappingURL=/JS-Web-Storage-localStorage.e31bb0bc.js.map